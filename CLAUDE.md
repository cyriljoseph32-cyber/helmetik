...
`cyriljoseph32-cyber/Coconut-Samui-Rugby-Academy`, dossier `brain/memoire/`. Au début d'une
tâche, la consulter si elle est accessible (checkout voisin
`/home/user/Coconut-Samui-Rugby-Academy/` ou via GitHub). Après un changement majeur ici,
mettre à jour `brain/memoire/journal.md` (et créer la fiche `brain/memoire/projets/helmetik.md`
si elle n'existe pas), ou le signaler à Cyril pour que l'agent `memory` s'en charge.
